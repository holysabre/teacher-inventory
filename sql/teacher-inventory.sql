/*
 ...
 Source Schema         : teacher-inventory

 Target Server Type    : MySQL
 Target Server Version : 80300 (8.3.0)
 File Encoding         : 65001

 Date: 28/05/2025 16:51:32
*/
...
-- ----------------------------
-- Table structure for pms_admin_asset
-- ----------------------------
DROP TABLE IF EXISTS `pms_admin_asset`;
CREATE TABLE `pms_admin_asset` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='个人资产表';

-- ----------------------------
-- Records of pms_admin_asset
-- ----------------------------
BEGIN;
INSERT INTO `pms_admin_asset` (`id`, `admin_id`, `supply_id`, `qty`, `create_time`) VALUES (1, 16, 1, 2, '2025-05-28 16:51:02');
COMMIT;

-- ----------------------------
-- Table structure for pms_inventory
-- ----------------------------
...
CREATE TABLE `pms_inventory` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='库存表';

-- ----------------------------
-- Records of pms_inventory
-- ----------------------------
BEGIN;
INSERT INTO `pms_inventory` (`id`, `supply_id`, `qty`, `last_update_time`) VALUES (1, 1, 15, '2025-05-28 11:26:00');
COMMIT;

-- ----------------------------
-- Table structure for pms_purchase
-- ----------------------------
...
CREATE TABLE `pms_purchase` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='采购表';

-- ----------------------------
-- Records of pms_purchase
-- ----------------------------
BEGIN;
INSERT INTO `pms_purchase` (`id`, `supply_id`, `qty`, `price`, `supplier`, `operator_id`, `create_time`) VALUES (1, 1, 19, 797.69, 'laboris', 16, '2025-05-28 13:58:19');
COMMIT;

-- ----------------------------
-- Table structure for pms_storage
-- ----------------------------
DROP TABLE IF EXISTS `pms_storage`;
CREATE TABLE `pms_storage` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `supply_id` bigint NOT NULL COMMENT '用品id',
  `qty` int NOT NULL COMMENT '数量',
  `type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '出入库类型',
  `operator_id` bigint NOT NULL COMMENT '操作人id',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='出入库表';

-- ----------------------------
-- Records of pms_storage
-- ----------------------------
BEGIN;
INSERT INTO `pms_storage` (`id`, `supply_id`, `qty`, `type`, `operator_id`, `create_time`) VALUES (1, 1, 5, 'in', 16, '2025-05-28 15:02:02');
COMMIT;

-- ----------------------------
-- Table structure for pms_supply
-- ----------------------------
DROP TABLE IF EXISTS `pms_supply`;
CREATE TABLE `pms_supply` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用品表';

-- ----------------------------
-- Records of pms_supply
-- ----------------------------
BEGIN;
INSERT INTO `pms_supply` (`id`, `type_id`, `name`, `spec`, `price`, `description`, `create_time`, `update_time`) VALUES (1, 1, '霜蒙', 'sint', 126.69, '米即受影主。图示每较列每适连当。路万根它除断管。太置办或收照起。较今近响。', NULL, NULL);
COMMIT;

-- ----------------------------
-- Table structure for pms_supply_operation
-- ----------------------------
DROP TABLE IF EXISTS `pms_supply_operation`;
CREATE TABLE `pms_supply_operation` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `audit_user_id` bigint DEFAULT NULL COMMENT '审核id',
  `audit_time` datetime DEFAULT NULL COMMENT '审核时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用品操作记录表';

-- ----------------------------
-- Records of pms_supply_operation
-- ----------------------------
BEGIN;
INSERT INTO `pms_supply_operation` (`id`, `admin_id`, `supply_id`, `operation_type`, `reason`, `qty`, `apply_time`, `status`, `audit_user_id`, `audit_time`) VALUES (1, 16, 1, 'receive', 'cillum sit nisi elit reprehenderit', 2, '2025-05-28 16:23:18', 'pass', 16, '2025-05-28 16:47:37');
INSERT INTO `pms_supply_operation` (`id`, `admin_id`, `supply_id`, `operation_type`, `reason`, `qty`, `apply_time`, `status`, `audit_user_id`, `audit_time`) VALUES (2, 16, 1, 'receive', 'cillum sit nisi elit reprehenderit', 5, '2025-05-28 16:41:23', 'pending', NULL, NULL);
COMMIT;

-- ----------------------------
-- Table structure for pms_supply_type
-- ----------------------------
DROP TABLE IF EXISTS `pms_supply_type`;
CREATE TABLE `pms_supply_type` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用品类型表';

-- ----------------------------
-- Records of pms_supply_type
-- ----------------------------
BEGIN;
INSERT INTO `pms_supply_type` (`id`, `name`, `description`, `create_time`, `update_time`) VALUES (1, '耗材', '耗材', NULL, NULL);
INSERT INTO `pms_supply_type` (`id`, `name`, `description`, `create_time`, `update_time`) VALUES (2, '教具', '教具', NULL, NULL);
INSERT INTO `pms_supply_type` (`id`, `name`, `description`, `create_time`, `update_time`) VALUES (3, '课本', '课本', NULL, NULL);
COMMIT;
...
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`, `login_time`, `status`) VALUES (16, 'pange', '$2a$10$ltNxV7uAKAZnhLZTO.96TOgP7CBYpFWPkTDsdOxpC1brHqpc495JW', '', 'pange@pange.com', 'pange', 'pange', '2025-05-28 08:54:45', NULL, 1);
COMMIT;
...
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (287, 16, '2025-05-28 08:55:12', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`) VALUES (288, 16, '2025-05-28 09:34:53', '0:0:0:0:0:0:0:1', NULL, NULL);
COMMIT;
